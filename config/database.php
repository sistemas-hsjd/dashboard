    ...
    */
    ...
    'connections' => [
        ...
        'generales' => [
            'driver' => 'mysql',
            'url' => env('DATABASE_URL'),
            'host' => env('DB_HOSTG', '127.0.0.1'),
            'port' => env('DB_PORTG', '3306'),
            'database' => env('DB_DATABASEG', 'forge'),
            'username' => env('DB_USERNAMEG', 'forge'),
            'password' => env('DB_PASSWORDG', ''),
            'unix_socket' => env('DB_SOCKET', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
        ...
        'mysql2' => [
            ...
            'database' => env('DB_DATABASE2', 'hospitalizacion'),
        ...
        'mysql3' => [
            ...
            'database' => env('DB_DATABASE3','pabellon'),
        ...
        'registro_clinico' => [
            ...
            'database' => env('DB_DATABASE6','registro_clinico'),
        ...
        'mysql9' => [
            ...
            'database' => env('DB_DATABASE9', 'generales'),
